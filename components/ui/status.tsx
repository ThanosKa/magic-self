  ...
  "inline-flex items-center gap-2 rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        offline:
          "border-transparent bg-slate-500/15 text-slate-700 hover:bg-slate-500/25 dark:text-slate-400",
        draft:
          "border-transparent bg-orange-500/15 text-orange-700 hover:bg-orange-500/25 dark:text-orange-400",
      },
    },
    defaultVariants: {
      variant: "default",
...
const statusIndicatorVariants = cva("h-2 w-2 rounded-full relative", {
  variants: {
    variant: {
      default: "bg-primary",
      ...
      online:
        "bg-green-500 animate-pulse before:absolute before:inset-0 before:rounded-full before:bg-green-500 before:animate-ping before:opacity-75",
