...
export function UsernameEditorView({
  username,
  onUsernameUpdate,
}: UsernameEditorViewProps) {
      ...
      <Drawer open={open} onOpenChange={setOpen}>
        <DrawerTrigger asChild>
          <Button
            variant="ghost"
            size="sm"
            className="h-auto px-1 py-0.5 font-mono text-sm font-medium"
          >
...
function UsernameForm({
  ...
  const showError =
    availability && !availability.available && newUsername !== currentUsername;
    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Only lowercase letters, numbers, and hyphens. Max{" "}
